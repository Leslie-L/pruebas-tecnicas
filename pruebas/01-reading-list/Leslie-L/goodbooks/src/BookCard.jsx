...
function BookCard(props) {
    ...
    return(<article className="flex-shrink-0 w-52  mr-6 relative shadow-xl">
            ...
            <button className="bg-gray-200 h-10 w-10 rounded-full absolute top-2 left-2 shadow-2xl hover:bg-primary hover:text-white" onClick={()=>props.favorites(props['bookInfo']['book'].ISBN)} ><FontAwesomeIcon icon={faBookmark}  /></button>
        </article>)
}
